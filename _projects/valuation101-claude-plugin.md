...
This is a side-project I took on to develop my skillset for 1) Go To Market 2) Building AI first, with Claude CoWork. 
...
It takes care of the entire pipeline, from data fetching, to parsing, the math behind each step of a valuation , putting it all together, preparing an excel model and case study report.

It demonstrates the capabilities of AI Plugins to resolve complex tasks, repeatably and reliably without hallucination.

### How to use it

Valuation 101 is still in beta, if you'd like to test it out for yourself, email me at craigds022@gmail.com
